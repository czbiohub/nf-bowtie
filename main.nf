 ...
 */
 // if(params.reference_input == 'single_file'){
 // fasta_ch = Channel.fromFile(params.reference)
 // process make_reference {
 //
 //   input:
 //   file fasta from params.reference
 //
 //   output:
...
params.fasta = "./test-data/fasta/CMS001_040_Ra_S21_contigs_test.fasta"
